      ...
      <section className="w-full bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8">
            Get started by uploading your resume or creating a job posting with us
          </p>
          <div className="flex justify-center gap-6">
            {isLoggedIn ? (
              ...
              <>
                <Link 
                  to="/login" 
                  className="bg-blue-700 text-white px-8 py-3 rounded-lg  hover:bg-blue-400 transition-colors"
                >
                  Login
                </Link>
                <Link 
